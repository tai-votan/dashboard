  ...
  ({ className, sticky, ...props }, ref) => {
    ...
    return (
      <div
        ...
        data-layout="header"
        className={cn(
          `z-10 flex h-[var(--header-height)] items-center gap-4 bg-background p-4 md:px-8 shadow-none`,
          {
            shadow: contextVal.offset > 10 && sticky,
            'flex-none': contextVal.fixed,
            'sticky top-0': sticky,
          },
          className,
        )}
  ...
  return (
    <div
      ...
      className={cn(
        ...
        { 'flex-1': contextVal && contextVal.fixed },
        className,
      )}
      {...props}
    />
